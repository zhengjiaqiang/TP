            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="<?php echo U('Category/insert');?>"><i class="icon-font">&#xe006;</i>分类添加</a></li>
                        <li><a href="<?php echo U('Article/insert');?>"><i class="icon-font">&#xe006;</i>文章添加</a></li>
                        <li><a href="<?php echo U('Article/index');?>"><i class="icon-font">&#xe006;</i>文章列表</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="<?php echo U('Export/upload');?>"><i class="icon-font">&#xe046;</i>Excel导入</a></li>
                        <li><a href="<?php echo U('Db/backups');?>"><i class="icon-font">&#xe046;</i>数据备份</a></li>
                        <li><a href="<?php echo U('Db/recovers');?>"><i class="icon-font">&#xe045;</i>数据还原</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i>
                   <?php  echo "<font color='red'>".session('username')."</font>"; ?>
                 <span>,欢迎来到单身男女</span>
              </div>
        </div>
